...
class CommunityCog(commands.Cog):
    ...
    async def demander(self, interaction: discord.Interaction, question: str) -> None:
        ...
        await training.create_request_channel(
            interaction, "community_help", level="Communauté", objective=question,
            availability="Dès qu’un Helper est disponible", budget="Gratuit", status="open", payment_status="not_required", invite_used=False,
        )
